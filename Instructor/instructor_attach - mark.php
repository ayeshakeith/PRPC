			...
			<div class = "container-fluid body-container">
				...
				<div class="container-fluid">
					<form class="form-horizontal" id="activity" action="#" method="post">
						<input type="file" id="myFile" name="myFile" style="color:black;">
						<br>
						<p style="font-size:25px; color:#282626; text-align:justify;">FILE PREVIEW:</p><br>
						<p><iframe style="width:100%; height:35vh; overflow-y:scroll;">
							<?php $file = fopen("President.txt", "r") or die("Unable to open file!");?>
						
						</iframe></p> <!--DITO LALABAS YUNG INUPLOAD NA FILE-->
