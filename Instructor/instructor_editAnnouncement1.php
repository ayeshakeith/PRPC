			...
			<div class = "container-fluid body-container">
				...
				<form class="form-horizontal" id="activity" action="instructor_announcementHandler.php" method="post"> 
				  <div class="form-group">
						...
						<input placeholder="Subject of Announcement" rows="9" id="subject1" name="subject1" style="font-size: 16px; color:black; padding:10px; width:30vw;"type="text" tabindex="1" 
								 value="<?php if (isset($_POST['subject1'])) echo $_POST['subject1']; ?>" required autofocus>
				  ...
				  <p style="font-size:20px; color:#282626; text-align:justify;">Announcement:</p><br>
					...
					<div class="container-fluid">
						<textarea class="form-control" rows="9" name="announcement1"><?php if (isset($_POST['announcement1'])) echo $_POST['announcement1']; ?></textarea>
						<br>
					
					</div>
						<div class="col-sm-4" style="float:right;">
						
							<input placeholder="Date & Time" id="date1" name="date1" style="font-size: 16px; color:black; padding:3px; width:20vw;"type="text" tabindex="1" 
								 value="<?php if (isset($_POST['date1'])) echo $_POST['date1']; ?>" required autofocus>
							<input placeholder="Professor's Name" id="ProfName1" name="ProfName1" style="font-size: 16px; color:black; padding:3px; width:20vw;"type="text" tabindex="1" 
								 value="<?php if (isset($_POST['ProfName1'])) echo $_POST['ProfName1']; ?>" required autofocus> 
						</div>
						<br><br><br><br>
					<center>
