			...
			<div class = "container-fluid body-container">
				...
				<div class="jumbotron" style="width:30%; height:55vh; border:2px solid #130d4c; background-color: #F6ebe4; padding:20px; overflow-y:scroll;">
					...
					<center>
						...
						<button type="submit" class="btn btn-default" style="width:8vw; background-color:#130d4c; color: #F6ebe4;">EDIT &nbsp;</button> <!--pagkasubmit balik sa instructor_uploadActivity.php-->
									<br>
						<button type="button" class="btn btn-default" style="width:12vw;  margin-top:1.2vh; background-color:#130d4c; color: #F6ebe4;"><a href="instructor_submission.php" style="color:#130d4c;">VIEW SUBMISSIONS &nbsp;</a></button>
					</center>
				</div>
