			...
			<div class = "container-fluid body-container" style="display: inline-block;">
				...
				<div class="container-fluid scrollmenu" style="display:flex;">
					...
					<div class="jumbotron" style="width:500px; height: 300px; border:5px solid #FCCB96; background-color:#EEEDFD; padding:20px;">
						...
						<h2 style="color:#282626; text-align: left; margin-right:100px;">Create New Activity</h2>
						<a href="class_addactivity.php" style="background-color: #EEEDFD;"><button class="btn btn-default btn-sm" style="display: inline-block; height:35px; border-radius:5px;"> <span class="glyphicon glyphicon-plus"></span> </button></a>
						</div>
						<br>
						<p class="container-fluid"style="color:#130d4c; text-align: justify; font-size:16px;">As an instructor, you could create and post activities for your students to see.
